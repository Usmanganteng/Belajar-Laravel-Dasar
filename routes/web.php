...
Route::get('/mai', function (){
    return "Hello Muhamad aldizar ilham";
});

Route::redirect('/youtube', '/mai');

Route::fallback(function () {
    return "404 by aldizar";
});

Route::view('/hello', 'hello', ['name' => 'aldizar']);

Route::get('/hello-again', function () {
    return view('hello', ['name' => 'aldizar']);
});

Route::get('/hello-world', function () {
    return view('hello.world', ['name' => 'aldizar']);
});
...
Route::get('/conflict/aldizar', function (){
    return "Conflict Muhamad Aldizar Ilham";
});
...
//    return route('redirect-hello', ['name' => 'Aldizar']);
//    return url()->route('redirect-hello', ['name' => 'Aldizar']);
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Aldizar']);
});

Route::middleware(['contoh:MAI,401'])->prefix('/middleware')->group(function (){
...
Route::post('/get', [\App\Http\Controllers\FormController::class, 'form']);
